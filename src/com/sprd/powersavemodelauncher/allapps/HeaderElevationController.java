...
public abstract class HeaderElevationController extends RecyclerView.OnScrollListener {
    ...
    public static class ControllerV16 extends HeaderElevationController {
        ...
        public ControllerV16(View header) {
            ...
            mScrollToElevation = res.getDimension(com.sprd.powersavemodelauncher.R.dimen.all_apps_header_scroll_to_elevation);
            ...
            FrameLayout.LayoutParams lp = new FrameLayout.LayoutParams(
                    ...
                    res.getDimensionPixelSize(com.sprd.powersavemodelauncher.R.dimen.all_apps_header_shadow_height));
    ...
    public static class ControllerVL extends HeaderElevationController {
        ...
        public ControllerVL(View header) {
            ...
            Resources res = header.getContext().getResources();
            mMaxElevation = res.getDimension(com.sprd.powersavemodelauncher.R.dimen.all_apps_header_max_elevation);
            mScrollToElevation = res.getDimension(com.sprd.powersavemodelauncher.R.dimen.all_apps_header_scroll_to_elevation);
        }

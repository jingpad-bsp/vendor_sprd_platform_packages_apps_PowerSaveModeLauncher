...
public class AllAppsBackgroundDrawable extends Drawable {
    ...
    public AllAppsBackgroundDrawable(Context context) {
        ...
        mHand = new TransformedImageDrawable(res, com.sprd.powersavemodelauncher.R.drawable.ic_all_apps_bg_hand,
                0.575f, 0.1f, Gravity.CENTER_HORIZONTAL);
        mIcons = new TransformedImageDrawable[4];
        mIcons[0] = new TransformedImageDrawable(res, com.sprd.powersavemodelauncher.R.drawable.ic_all_apps_bg_icon_1,
                0.375f, 0, Gravity.CENTER_HORIZONTAL);
        mIcons[1] = new TransformedImageDrawable(res, com.sprd.powersavemodelauncher.R.drawable.ic_all_apps_bg_icon_2,
                0.3125f, 0.25f, Gravity.CENTER_HORIZONTAL);
        mIcons[2] = new TransformedImageDrawable(res, com.sprd.powersavemodelauncher.R.drawable.ic_all_apps_bg_icon_3,
                0.475f, 0.4f, Gravity.CENTER_HORIZONTAL);
        mIcons[3] = new TransformedImageDrawable(res, com.sprd.powersavemodelauncher.R.drawable.ic_all_apps_bg_icon_4,
                0.7f, 0.125f, Gravity.CENTER_HORIZONTAL);
        mWidth = res.getDimensionPixelSize(com.sprd.powersavemodelauncher.R.dimen.all_apps_background_canvas_width);
        mHeight = res.getDimensionPixelSize(com.sprd.powersavemodelauncher.R.dimen.all_apps_background_canvas_height);
    }

...
public class AllAppsGridAdapter extends RecyclerView.Adapter<AllAppsGridAdapter.ViewHolder> {
    ...
    public AllAppsGridAdapter(PowerSaveLauncher powerSaveLauncher, AlphabeticalAppsList apps,
                              View.OnTouchListener touchListener, View.OnClickListener iconClickListener) {
        Resources res = powerSaveLauncher.getResources();
        mPowerSaveLauncher = powerSaveLauncher;
        mApps = apps;
        mEmptySearchMessage = res.getString(com.sprd.powersavemodelauncher.R.string.all_apps_loading_message);
        mGridSizer = new GridSpanSizer();
        mGridLayoutMgr = new AppsGridLayoutManager(powerSaveLauncher);
        mGridLayoutMgr.setSpanSizeLookup(mGridSizer);
        mItemDecoration = new GridItemDecoration();
        mLayoutInflater = LayoutInflater.from(powerSaveLauncher);
        ...
        mSectionHeaderOffset = res.getDimensionPixelSize(com.sprd.powersavemodelauncher.R.dimen.all_apps_grid_section_y_offset);
        mIsRtl = Utilities.isRtl(res);

        mSectionTextPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mSectionTextPaint.setTextSize(res.getDimensionPixelSize(
                com.sprd.powersavemodelauncher.R.dimen.all_apps_grid_section_text_size));
        mSectionTextPaint.setColor(res.getColor(com.sprd.powersavemodelauncher.R.color.all_apps_grid_section_text_color));

        mPredictedAppsDividerPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mPredictedAppsDividerPaint.setStrokeWidth(Utilities.pxFromDp(1f, res.getDisplayMetrics()));
        mPredictedAppsDividerPaint.setColor(0x1E000000);
        mPredictionBarDividerOffset =
                (-res.getDimensionPixelSize(com.sprd.powersavemodelauncher.R.dimen.all_apps_prediction_icon_bottom_padding) +
                        res.getDimensionPixelSize(com.sprd.powersavemodelauncher.R.dimen.all_apps_icon_top_bottom_padding)) / 2;
    }
    ...
    public void setSearchController(AllAppsSearchBarController searchController) {
        ...
        PackageManager pm = mPowerSaveLauncher.getPackageManager();
    ...
    public void setLastSearchQuery(String query) {
        Resources res = mPowerSaveLauncher.getResources();
        String formatStr = res.getString(com.sprd.powersavemodelauncher.R.string.all_apps_no_search_results);
        mEmptySearchMessage = String.format(formatStr, query);
        if (mMarketAppName != null) {
            mMarketSearchMessage = String.format(res.getString(com.sprd.powersavemodelauncher.R.string.all_apps_search_market_message),
                    mMarketAppName);
        ...
        switch (viewType) {
            ...
            case ICON_VIEW_TYPE:{
                BubbleTextView icon = (BubbleTextView) mLayoutInflater.inflate(
                        com.sprd.powersavemodelauncher.R.layout.all_apps_icon, parent, false);
            ...
            case PREDICTION_ICON_VIEW_TYPE: {
                BubbleTextView icon = (BubbleTextView) mLayoutInflater.inflate(
                        com.sprd.powersavemodelauncher.R.layout.all_apps_prediction_bar_icon, parent, false);
                icon.setOnTouchListener(mTouchListener);
                icon.setOnClickListener(mIconClickListener);
                icon.setFocusable(true);
                return new ViewHolder(icon);
            ...
            case EMPTY_SEARCH_VIEW_TYPE:
                return new ViewHolder(mLayoutInflater.inflate(com.sprd.powersavemodelauncher.R.layout.all_apps_empty_search,
                        parent, false));
            case SEARCH_MARKET_DIVIDER_VIEW_TYPE:
                return new ViewHolder(mLayoutInflater.inflate(com.sprd.powersavemodelauncher.R.layout.all_apps_search_market_divider,
                        parent, false));
            case SEARCH_MARKET_VIEW_TYPE:
                View searchMarketView = mLayoutInflater.inflate(com.sprd.powersavemodelauncher.R.layout.all_apps_search_market,
                        parent, false);
                searchMarketView.setVisibility(View.INVISIBLE);

...
import com.sprd.powersavemodelauncher.BaseRecyclerView;
...
public class AllAppsRecyclerView extends BaseRecyclerView {
    ...
    public AllAppsRecyclerView(Context context, AttributeSet attrs, int defStyleAttr,
        ...
        mEmptySearchBackgroundTopOffset = res.getDimensionPixelSize(
                com.sprd.powersavemodelauncher.R.dimen.all_apps_empty_search_bg_top_offset);
    }
    ...
    public void setNumAppsPerRow(DeviceProfile grid, int numAppsPerRow) {
        ...
        int approxRows = (int) Math.ceil((double) grid.availableHeightPx / grid.allAppsIconSizePx);
    ...
    private void updateEmptySearchBackgroundBounds() {
        ...
        int y = mEmptySearchBackgroundTopOffset - 132;

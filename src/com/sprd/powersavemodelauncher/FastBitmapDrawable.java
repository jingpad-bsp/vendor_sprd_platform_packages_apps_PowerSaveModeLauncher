...
public class FastBitmapDrawable extends Drawable {
    ...
    public enum State {
        ...
        NORMAL                      (0f, 0f, 1f),
        PRESSED                     (0f, 100f / 255f, 1f),
        FAST_SCROLL_HIGHLIGHTED     (0f, 0f, 1.15f),
        FAST_SCROLL_UNHIGHLIGHTED   (0f, 0f, 1f),
        DISABLED                    (1f, 0.5f, 1f);
        ...
        State(float desaturation, float brightness, float viewScale) {
    ...
    public static final int CLICK_FEEDBACK_DURATION = 300;
